...
public class PrefixIndex<T> {
  ...
  public boolean isEmpty() {
    return Arrays.mismatch(keys, offset, offset + range, PROTOTYPE, offset, offset + range) == -1;
  }
  ...
  public <U>
  double reduceDouble(double initial, IntFunction<U> mapKey, uk.co.openkappa.splitmap.ToDoubleBiFunction<T, U> mapValue, DoubleBinaryOperator reduce) {
